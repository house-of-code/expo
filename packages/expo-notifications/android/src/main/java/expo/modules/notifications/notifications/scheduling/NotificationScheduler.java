...
public class NotificationScheduler extends ExportedModule {
  ...
  protected NotificationTrigger triggerFromParams(@Nullable ReadableArguments params) throws InvalidArgumentException {
    ...
    switch (params.getString("type")) {
      ...
      case "monthly":
        if (!(params.get("day") instanceof Number) || !(params.get("month") instanceof Number) || !(params.get("hour") instanceof Number) || !(params.get("minute") instanceof Number) || !(params.get("repeatAmount") instanceof Number)) {
        ...
        return new MonthlyTrigger(
          ...
          ((Number) params.get("hour")).intValue(),
          ((Number) params.get("minute")).intValue(),          
          ((Number) params.get("repeatAmount")).intValue(),
          channelId
        );
      case "yearly":
